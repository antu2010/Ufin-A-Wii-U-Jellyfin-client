...
**Heads up before you start:** I wrote this against my knowledge of the
...
Edit `src/config.h` first:
```cpp
#define UFIN_SERVER_HOST "192.168.1.50"  // your N100 box's LAN IP
#define UFIN_SERVER_PORT 8096
#define UFIN_USERNAME "antu2010"
...
- The exact build error/warning, full text.
- Which step in this README you were on.
- If it builds but crashes/hangs on console: what you saw on screen (or a
  photo), and whether it happened at boot, after auth, or during
  navigation.
